...
N <- round(exp(seq(log(1), log(0.75*max(x)), length.out = 50)))
...
plot(N[1:47], sampThr[1:47, 1], ylim = range(sampThr[1:47, ]), log = 'xy', 
     type = 'b', pch = 16, cex = 0.5)
points(N[1:47], sampThr[1:47, 2], type = 'b', cex = 0.6, pch = 16, col = 'red')
